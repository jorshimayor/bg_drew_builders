      ...
      <section className="py-10 sm:py-10 lg:py-20">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-xl font-bold leading-tight text-white sm:text-2xl pt-12 md:pt-2 lg:text-3xl">
              Reach out to us today, and let's embark on a journey to construct
              something extraordinary. Your dream building is just a call away!
            </h2>
          </div>
